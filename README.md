...
- **Hybridization engine** assigns sp/sp²/sp³ from measured bond angles, with geometry-derived conjugation detection (furan O, aniline N, amide N) and OH-override for oxygen lone pairs
